...
class ScanViewController: BaseViewController {
    ...
    private var goToDetailsButton: StyleButton!
    ...
    private func showPicker() {
        ...
        symbolNameLabel.text = "Please take a picture or select an image from your Photo Library to begin identification"
...
extension ScanViewController {
    private func initializeView() {
        ...
        goToDetailsButton = .init(with: .primaryIconRight, title: "See Details")
        goToDetailsButton.iconImageView.image = .named("icon-24-arrow-right")
        goToDetailsButton.dropCorner(Constants.cornerRadius)
        goToDetailsButton.backgroundColor = .mainOrange
        goToDetailsButton.titleColor = .styleWhite
        goToDetailsButton.isHidden = true
        ...
        view.addSubview(goToDetailsButton)
    }
    ...
    private func layoutConstraint() {
        ...
        goToDetailsButton.layout {
            $0.top == symbolNameLabel.bottomAnchor + 20
            $0.leading == view.leadingAnchor + 20
            $0.trailing == view.trailingAnchor - 20
            $0.height |=| 48
        }
