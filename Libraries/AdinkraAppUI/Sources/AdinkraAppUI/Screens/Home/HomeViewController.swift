...
private enum Constants {
    ...
    static let scrollViewHeight: CGFloat = 1050
}
...
class HomeViewController: BaseViewController {
    ...
    private var randomSymbol = Int.random(in: 0...59)
    ...
    private func randomizeSymbol() {
        symbolOfTheDayView.symbolNameLabel.text = symbols[Int(randomSymbol)].title
        ...
        if symbols[Int(randomSymbol)].pronunciation == "" {
            ...
            symbolOfTheDayView.soundButton.iconImageView.setImageMaskColor(.red)
            symbolOfTheDayView.soundButton.isUserInteractionEnabled = false
        }
    }
    ...
    private func playSound() {
        guard let url = Bundle.module.url(forResource: symbols[Int(randomSymbol)].pronunciation, withExtension: "mp3") else {
