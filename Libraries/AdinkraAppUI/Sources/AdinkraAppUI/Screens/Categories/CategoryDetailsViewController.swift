...
class CategoryDetailsViewController: BaseViewController {
    ...
    var wealthSymbols: [SymbolPresentationModel] = [
        .init(id: 2, symbol: .named("symbol-abe-dua"), title: "Abe Dua", meaning: "Abe Dua means palm tree.", description: "The palm tree is a symbol resourcefulnees because many diverse products emanate from that single tree: wine, oil, brooms, roofing material, etc.", pronunciation: "LOL", categories: ["Wealth"], isFavorite: false),
        .init(id: 13, symbol: .named("symbol-asase-ye-duru"), title: "Asase Ye Duru", meaning: "Asase Ye Duru means “the earth has weight.” It is a symbol of providence and the divinity of Mother Earth.", description: "Tumi nyina ne asase; All power emanates from the earth.", pronunciation: "LOL", categories: ["Nature", "Wealth"], isFavorite: false)
    ]
    
    var wisdomSymbols: [SymbolPresentationModel] = [
        .init(id: 8, symbol: .named("symbol-akoko-nan"), title: "Akoko Nan", meaning: "The foot of a hen. It is a symbol for nurturing coupled with discipline", description: "This Adinkra is from the proverb, “Akoko nan tia ba na enkum ba,” literally, “The foot of a hen steps on the child (chick) but it doesn’t kill the child (chick).”", pronunciation: "LOL", categories: ["Wisdom"], isFavorite: false),
