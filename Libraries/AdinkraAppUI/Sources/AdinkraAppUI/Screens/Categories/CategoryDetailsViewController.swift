...
class CategoryDetailsViewController: BaseViewController {
    ...
    var faithSymbols: [SymbolPresentationModel] = [
        .init(id: 5, symbol: .named("symbol-agyindawuru"), title: "Agyindawuru", meaning: "Agyin’s gong. A symbol of faithfulness, alertness, and dutifulness", description: "Designed to commemorate the faithfulness of one Agyin who was a dutiful servant and gong-beater to the Asantehene.", pronunciation: "agyindawuru", categories: ["Faith"], isFavorite: false),
    ...
    var loveSymbols: [SymbolPresentationModel] = [
        ...
        .init(id: 26, symbol: .named("symbol-fanfanto"), title: "Fanfanto", meaning: "Fafanto means “butterfly.” It is a symbol of tenderness, gentleness, honesty, and fragility.", description: "The butterfly is a tender and gentle creature fluttering around with its beautiful wings.The symbol embodies the essence of the butterfly; fragility, gentleness and tenderness. It can also be likened to the freedom the butterflies enjoy, flying around without a care in the world.", pronunciation: "fanfanto", categories: ["Love", "Peace"], isFavorite: false),
    ...
    var wealthSymbols: [SymbolPresentationModel] = [
        .init(id: 2, symbol: .named("symbol-abe-dua"), title: "Abe Dua", meaning: "Abe Dua means palm tree.", description: "The palm tree is a symbol resourcefulnees because many diverse products emanate from that single tree: wine, oil, brooms, roofing material, etc.", pronunciation: "abe-dua", categories: ["Wealth"], isFavorite: false),
        .init(id: 13, symbol: .named("symbol-asase-ye-duru"), title: "Asase Ye Duru", meaning: "Asase Ye Duru means “the earth has weight.” It is a symbol of providence and the divinity of Mother Earth.", description: "Tumi nyina ne asase; All power emanates from the earth.", pronunciation: "asase-ye-duru", categories: ["Nature", "Wealth"], isFavorite: false)
    ]
    
    var wisdomSymbols: [SymbolPresentationModel] = [
        .init(id: 8, symbol: .named("symbol-akoko-nan"), title: "Akoko Nan", meaning: "The foot of a hen. It is a symbol for nurturing coupled with discipline", description: "This Adinkra is from the proverb, “Akoko nan tia ba na enkum ba,” literally, “The foot of a hen steps on the child (chick) but it doesn’t kill the child (chick).”", pronunciation: "akoko-nan", categories: ["Wisdom"], isFavorite: false),
